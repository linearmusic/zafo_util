...
export class App {
    ...
    async generator() {
        ...
        for (let userId = 1; userId <= 100; userId++) {
            ...
            // 80% chance to proceed to booking
            if (Math.random() < 0.8) {
